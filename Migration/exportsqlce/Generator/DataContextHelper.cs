...
";
            ...
            if (i > -1)
            {
                ...
                dcLines.Insert(i++, n + T(4) + "string[] names = this.GetType().Assembly.GetManifestResourceNames();");
                dcLines.Insert(i++, n + T(4) + "string name = names.Where(n => n.EndsWith(FileName)).FirstOrDefault();");
                dcLines.Insert(i++, n + T(4) + "if (name != null)");
                dcLines.Insert(i++, n + T(4) + "{");
                dcLines.Insert(i++, n + T(5) + "using (Stream resourceStream = Assembly.GetExecutingAssembly().GetManifestResourceStream(name))");
                dcLines.Insert(i++, n + T(5) + "{");
                dcLines.Insert(i++, n + T(6) + "if (resourceStream != null)");
                dcLines.Insert(i++, n + T(6) + "{");
                dcLines.Insert(i++, n + T(7) + "using (IsolatedStorageFile myIsolatedStorage = IsolatedStorageFile.GetUserStoreForApplication())");
                dcLines.Insert(i++, n + T(7) + "{");
                dcLines.Insert(i++, n + T(8) + "using (IsolatedStorageFileStream fileStream = new IsolatedStorageFileStream(FileName, FileMode.Create, myIsolatedStorage))");
                dcLines.Insert(i++, n + T(8) + "{");
                dcLines.Insert(i++, n + T(9) + "using (BinaryWriter writer = new BinaryWriter(fileStream))");
                dcLines.Insert(i++, n + T(9) + "{");
                dcLines.Insert(i++, n + T(10) + "long length = resourceStream.Length;");
                dcLines.Insert(i++, n + T(10) + "byte[] buffer = new byte[32];");
                dcLines.Insert(i++, n + T(10) + "int readCount = 0;");
                dcLines.Insert(i++, n + T(10) + "using (BinaryReader reader = new BinaryReader(resourceStream))");
                dcLines.Insert(i++, n + T(10) + "{");
                dcLines.Insert(i++, n + T(11) + "// read file in chunks in order to reduce memory consumption and increase performance");
                dcLines.Insert(i++, n + T(11) + "while (readCount < length)");
                dcLines.Insert(i++, n + T(11) + "{");
                dcLines.Insert(i++, n + T(12) + "int actual = reader.Read(buffer, 0, buffer.Length);");
                dcLines.Insert(i++, n + T(12) + "readCount += actual;");
                dcLines.Insert(i++, n + T(12) + "writer.Write(buffer, 0, actual);");
                dcLines.Insert(i++, n + T(11) + "}");
                dcLines.Insert(i++, n + T(10) + "}");
                dcLines.Insert(i++, n + T(9) + "}");
                dcLines.Insert(i++, n + T(8) + "}");
                dcLines.Insert(i++, n + T(7) + "}");
                dcLines.Insert(i++, n + T(7) + "created = true;");
                dcLines.Insert(i++, n + T(6) + "}");
                dcLines.Insert(i++, n + T(6) + "else");
                dcLines.Insert(i++, n + T(6) + "{");
                dcLines.Insert(i++, n + T(7) + "db.CreateDatabase();");
                dcLines.Insert(i++, n + T(7) + "created = true;");
                dcLines.Insert(i++, n + T(6) + "}");
                dcLines.Insert(i++, n + T(5) + "}");
                dcLines.Insert(i++, n + T(4) + "}");
                dcLines.Insert(i++, n + T(4) + "else");
                dcLines.Insert(i++, n + T(4) + "{");
                dcLines.Insert(i++, n + T(5) + "db.CreateDatabase();");
                dcLines.Insert(i++, n + T(5) + "created = true;");
                dcLines.Insert(i++, n + T(4) + "}");
                dcLines.Insert(i++, n + T(3) + "}");
                dcLines.Insert(i++, n + T(2) + "}");
